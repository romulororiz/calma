      ...
      >
        {benefits.map((benefit, index) => (
          ...
          >
            ...
            <div
              className={`${
                benefit.featured ? 'h-[70px] w-[70px]' : 'h-[70px] w-[70px]'
              } mb-6 flex items-center justify-center rounded-[20px] bg-gradient-to-br from-[var(--purple-primary)] to-[var(--pink-vibrant)] text-[2rem] shadow-[0_10px_25px_rgba(139,92,246,0.3)]`}
            >
              {benefit.icon}
            </div>
            ...
            <h4
              className={`${
                benefit.featured ? 'text-[2.25rem]' : 'text-[1.75rem]'
              } mb-4 font-bold text-[var(--text-primary)]`}
            >
              {benefit.title}
            </h4>
            ...
            <p
              className={`text-[var(--text-secondary)] ${
                benefit.featured ? 'text-[1.25rem]' : 'text-[1.125rem]'
              } leading-[1.7]`}
            >
              {benefit.description}
            </p>
