      ...
      >
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-[rgba(139,92,246,0.2)] to-[rgba(236,72,153,0.2)] text-[2.5rem] transition-all duration-500 group-hover:scale-110 group-hover:rotate-[5deg] group-hover:bg-gradient-to-br group-hover:from-[var(--purple-primary)] group-hover:to-[var(--pink-vibrant)] group-hover:shadow-[0_15px_30px_rgba(139,92,246,0.4)]">
              {feature.icon}
            </div>
